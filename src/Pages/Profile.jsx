...
import { Container, Card, CardContent, Typography, Avatar, Grid, Button, TextField, Collapse, Checkbox, FormControlLabel } from "@mui/material";
    ...
    try {
      ...
      if (response.ok) {
        setProfileData((prevData) => ({
          ...prevData,
          bookings: prevData.bookings.filter((booking) => booking.id !== bookingId),
        }));
  ...
  const handleCreateVenue = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error("Failed to create venue:", errorData.message || response.statusText);
      }
    } catch (error) {
...
/>
                      ...
                      <TextField
                        ...
                        onChange={(e) => setVenueForm((prevForm) => ({ ...prevForm, media: [{ url: e.target.value, alt: "" }] }))}
                        sx={{ mt: 2 }}  
                      />
                      <TextField
                        label="Price"
  ...
  <Grid container spacing={2}>
        ...
        control={
          <Checkbox
            ...
            onChange={(e) =>
              setVenueForm((prevForm) => ({
                ...prevForm,
                meta: { ...prevForm.meta, wifi: e.target.checked },
              }))
            }
            name="wifi"
            color="primary"
        ...
        control={
          <Checkbox
            ...
            onChange={(e) =>
              setVenueForm((prevForm) => ({
                ...prevForm,
                meta: { ...prevForm.meta, parking: e.target.checked },
              }))
            }
            name="parking"
            color="primary"
        ...
        control={
          <Checkbox
            ...
            onChange={(e) =>
              setVenueForm((prevForm) => ({
                ...prevForm,
                meta: { ...prevForm.meta, breakfast: e.target.checked },
              }))
            }
            name="breakfast"
            color="primary"
    ...
    <Grid item xs={12} md={6}>
        ...
        control={
          <Checkbox
            ...
            onChange={(e) =>
              setVenueForm((prevForm) => ({
                ...prevForm,
                meta: { ...prevForm.meta, pets: e.target.checked },
              }))
            }
            name="pets"
            color="primary"
      ...
      />
                      ...
                      {/* Add fields for media, meta, and location as needed */}
                      <Button
                        variant="contained"
                        color="secondary"
